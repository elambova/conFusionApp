...
var app = angular.module('conFusion', ['ionic', 'ngCordova', 'conFusion.controllers', 'conFusion.services']);

app.run(function ($ionicPlatform, $rootScope, $ionicLoading, $cordovaSplashscreen, $timeout) {
